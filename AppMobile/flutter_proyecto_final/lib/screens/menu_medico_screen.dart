...
class MenuMedicoScreen extends StatefulWidget {
  const MenuMedicoScreen({Key? key}) : super(key: key);

  @override
  _MenuMedicoScreenState createState() => _MenuMedicoScreenState();
}

class _MenuMedicoScreenState extends State<MenuMedicoScreen> {
  int _currentIndex = 0;
