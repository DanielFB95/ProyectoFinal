...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        ...
        http
                ...
                .antMatchers(HttpMethod.GET,"/medico/pacientes/{id}").hasAnyRole("ADMIN","MEDICO")
                .antMatchers(HttpMethod.PUT,"/medico/{id}").hasAnyRole("ADMIN","MEDICO")
                .antMatchers(HttpMethod.DELETE,"/medico/{id}").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/user/paciente/{id}").hasAnyRole("ADMIN","MEDICO")
                ...
                .antMatchers(HttpMethod.GET, "paciente/recetas/{id}").hasAnyRole("ADMIN","MEDICO","PACIENTE")
